export default {
  ...
  // Header
  header_ai_online: 'AI TRỰC TUYẾN',
  view_home_title: 'AURA',
  view_home_subtitle: 'Nền tảng Thông minh Thời trang AI',
  ...
  // Sidebar Footer
  sidebar_ai_active: 'Động cơ AI Đang Chạy',
  sidebar_view_github: 'Xem trên GitHub',
  sidebar_subtitle: 'Stylist Thời trang AI',

  // Home View
  home_hero_title: 'Giám đốc Thời trang AI Cá nhân',
  home_hero_desc: 'Trải nghiệm sự giao thoa giữa thời trang cao cấp và trí tuệ nhân tạo. Tải lên trang phục để phân tích thẩm mỹ tức thì hoặc trò chuyện với stylist ảo.',
  home_btn_analyze: 'Phân tích Trang phục',
  ...
  analyze_upload_title: 'Tải Tệp Lên',
  analyze_drag_drop: 'Kéo thả bức ảnh của bạn vào đây',
  ...
  chat_quick_prompts_list: [
    'Mặc đồ gì đi phỏng vấn việc làm?',
    'Lần hẹn hò đầu tiên mặc sao cho ấn tượng?',
    'Tạo cho mình một danh sách Capsule Wardrobe',
    'Đi dự tiệc Gala nên mặc gì?',
    'Giải thích phong cách Quiet Luxury',
  ...
  history_subtitle: 'Nhìn lại các phong cách đã phân tích và các gợi ý phối đồ của bạn.',
  history_empty: 'Chưa có dữ liệu nào.',
  history_btn_new: 'Phân tích Tấm Mới',
