export default {
  ...
  // Header
  header_ai_online: 'AI ONLINE',
  view_home_title: 'AURA',
  view_home_subtitle: 'AI Fashion Intelligence Platform',
  ...
  // Sidebar Footer
  sidebar_ai_active: 'AI Engine Active',
  sidebar_view_github: 'View on GitHub',
  sidebar_subtitle: 'AI Fashion Stylist',

  // Home View
  home_hero_title: 'Your Personal AI Fashion Director',
  home_hero_desc: 'Experience the intersection of haute couture and artificial intelligence. Upload an outfit for instant aesthetic analysis or consult your personalized stylist.',
  home_btn_analyze: 'Analyze Outfit',
  ...
  analyze_occasions: 'OCCASIONS',
  analyze_style_tips: 'STYLING NOTES',
  analyze_score: 'Score',
  ...
  history_subtitle: 'Your previously analyzed looks and their styling recommendations.',
  history_empty: 'No analyses yet.',
  history_btn_new: 'Analyze New Outfit',
